...
import (
	...
	"github.com/llm-d/llm-d-inference-payload-processor/pkg/framework/plugins/modelselector/filter/requestedmodels"
...
func (r *Runner) registerInTreePlugins() {
	...
	plugin.Register(requestedmodels.RequestedModelsFilterType, requestedmodels.RequestedModelsFilterFactory)
